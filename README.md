...
Android 构建要求 JDK 21+ 和 Android SDK 35；本机已完成创作工作台 v0.1.5 构建。真实 VPS 联调、真机弱网和发布渠道签名仍需在目标环境补齐。

当前本地构建的 APK 位于 `release/creative-workbench-v0.1.5.apk`，校验值见 `release/SHA256SUMS.txt`。
